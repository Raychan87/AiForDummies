...
== Beschreibung der einzelnen KI Komponenten

=== [blue]#Modus passend auswählen#
...
'''
=== [blue]#Instrutioncs: Regeln, Stil, Architektur, Sicherheit#
